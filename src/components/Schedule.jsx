...
const Schedule = () => {
  return (
    <>
      <section
        id="schedule"
        className="h-screen w-full px-4 text-[#4a4a4a] flex items-center justify-center pt-12 -translate-y-[10vh]"
      >
        <div className="w-full">
          <div className="max-w-4xl mx-auto">
            <div className="space-y-6">
              <h3 className="text-xl font-semibold font-serif">Tea Ceremony</h3>
